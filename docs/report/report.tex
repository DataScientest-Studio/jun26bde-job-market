...
%\usepackage[a4paper,margin=4.5cm]{geometry} \pagestyle{empty}
\usepackage{xcolor}
...
% TODO: Unsuccessful lookups are also recorded through the \path{failed_geocoding_requests} metric. The metric represents the number of failed geocoding requests in the current ETL run and is subsequently submitted to Prometheus through Pushgateway together with the other ETL metrics.
